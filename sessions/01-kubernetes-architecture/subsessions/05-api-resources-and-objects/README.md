# Sub-Session 05: Api Resources And Objects

This sub-session is part of 01-kubernetes-architecture.

## Goal

Group, Version, Kind, Resource, Namespace.
...
```bash
kubectl apply -f subsessions/05-api-resources-and-objects/
```
...
```bash
kubectl delete -f subsessions/05-api-resources-and-objects/ --ignore-not-found
```
