# Sub-Session 01: Control Plane Overview
...
```bash
kubectl apply -f subsessions/01-control-plane-overview/
```
...
```bash
kubectl delete -f subsessions/01-control-plane-overview/ --ignore-not-found
```
