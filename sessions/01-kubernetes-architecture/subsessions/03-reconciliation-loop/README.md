# Sub-Session 03: Reconciliation Loop

This sub-session is part of 01-kubernetes-architecture.

## Goal

desired state, observed state, controllers.
...
```bash
kubectl apply -f subsessions/03-reconciliation-loop/
```
...
```bash
kubectl delete -f subsessions/03-reconciliation-loop/ --ignore-not-found
```
