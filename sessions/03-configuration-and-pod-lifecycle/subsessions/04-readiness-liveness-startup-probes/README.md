# Sub-Session 04: Readiness Liveness Startup Probes

This sub-session is part of 03-configuration-and-pod-lifecycle.

## Goal

health checks and traffic safety.
...
```bash
kubectl apply -f subsessions/04-readiness-liveness-startup-probes/
```
...
```bash
kubectl delete -f subsessions/04-readiness-liveness-startup-probes/ --ignore-not-found
```
