# Sub-Session 05: Lifecycle Hooks

This sub-session is part of 03-configuration-and-pod-lifecycle.

## Goal

`postStart`, `preStop`, and graceful shutdown.
...
```bash
kubectl apply -f subsessions/05-lifecycle-hooks/
```
...
```bash
kubectl delete -f subsessions/05-lifecycle-hooks/ --ignore-not-found
```
