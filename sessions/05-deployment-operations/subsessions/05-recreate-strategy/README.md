# Sub-Session 05: Recreate Strategy

This sub-session is part of 05-deployment-operations.

## Goal

compare Recreate with RollingUpdate.
...
```bash
kubectl apply -f subsessions/05-recreate-strategy/
```
...
```bash
kubectl delete -f subsessions/05-recreate-strategy/ --ignore-not-found
```
