# Sub-Session 07: Common Rollout Failures

This sub-session is part of 05-deployment-operations.

## Goal

bad image, bad probe, bad config.
...
```bash
kubectl apply -f subsessions/07-common-rollout-failures/
```
...
```bash
kubectl delete -f subsessions/07-common-rollout-failures/ --ignore-not-found
```
