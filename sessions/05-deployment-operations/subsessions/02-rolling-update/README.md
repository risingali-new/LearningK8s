# Sub-Session 02: Rolling Update

This sub-session is part of 05-deployment-operations.

## Goal

update image tags and observe ReplicaSets.
...
```bash
kubectl apply -f subsessions/02-rolling-update/
```
...
```bash
kubectl delete -f subsessions/02-rolling-update/ --ignore-not-found
```
