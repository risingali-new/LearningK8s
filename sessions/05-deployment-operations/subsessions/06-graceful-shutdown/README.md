# Sub-Session 06: Graceful Shutdown

This sub-session is part of 05-deployment-operations.

## Goal

termination grace period and zero-downtime releases.
...
```bash
kubectl apply -f subsessions/06-graceful-shutdown/
```
...
```bash
kubectl delete -f subsessions/06-graceful-shutdown/ --ignore-not-found
```
