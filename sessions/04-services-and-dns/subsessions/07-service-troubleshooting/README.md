# Sub-Session 07: Service Troubleshooting

This sub-session is part of 04-services-and-dns.

## Goal

selector mismatch, no endpoints, DNS failures.
...
```bash
kubectl apply -f subsessions/07-service-troubleshooting/
```
...
```bash
kubectl delete -f subsessions/07-service-troubleshooting/ --ignore-not-found
```
