# Sub-Session 05: Coredns

This sub-session is part of 04-services-and-dns.

## Goal

Kubernetes DNS names and lookup flow.
...
```bash
kubectl apply -f subsessions/05-coredns/
```
...
```bash
kubectl delete -f subsessions/05-coredns/ --ignore-not-found
```
