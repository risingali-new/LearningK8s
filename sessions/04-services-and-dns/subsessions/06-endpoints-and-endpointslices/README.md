# Sub-Session 06: Endpoints And Endpointslices

This sub-session is part of 04-services-and-dns.

## Goal

how Services find backing Pods.
...
```bash
kubectl apply -f subsessions/06-endpoints-and-endpointslices/
```
...
```bash
kubectl delete -f subsessions/06-endpoints-and-endpointslices/ --ignore-not-found
```
