# Sub-Session 02: Clusterip

This sub-session is part of 04-services-and-dns.

## Goal

stable internal virtual IP and DNS.
...
```bash
kubectl apply -f subsessions/02-clusterip/
```
...
```bash
kubectl delete -f subsessions/02-clusterip/ --ignore-not-found
```
