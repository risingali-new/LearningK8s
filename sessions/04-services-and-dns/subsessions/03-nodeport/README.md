# Sub-Session 03: Nodeport

This sub-session is part of 04-services-and-dns.

## Goal

exposing a Service on every node.
...
```bash
kubectl apply -f subsessions/03-nodeport/
```
...
```bash
kubectl delete -f subsessions/03-nodeport/ --ignore-not-found
```
